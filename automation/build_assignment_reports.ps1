...
function Build-Version {
    ...
    Add-Visual -Report $report -Page "q09" -Type "line" -Name "q09_chart" -Title "Order Volume Trend by Month-Year" -Bindings @("--category", "PizzaOrders[Order Month Start]", "--value", "PizzaOrders[Order Count]")
